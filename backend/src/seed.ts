...
async function seed() {
  ...
  const siteData: Array<{
    ...
    { siteCode: "APP VN", siteName: "VERTIS NORTH", invoicePrefix: "VNSSR#", address: "Mobile Care Services Philippines, Inc. By Power Mac Center Vertis North, Apple Authorized Service Provider 3/F Unit R1-L3-006 Ayala Malls Vertis North, Bagong Pag-Asa Quezon City, Philippines 1100", contactEmails: '[]', shipToCode: "1506282" },
    { siteCode: "ASP MK", siteName: "SM MARIKINA", invoicePrefix: "MRKSSR#", address: "Marcos Highway, Barangay Calumpang, Marikina City, Metro Manila, Philippines", contactEmails: '[]', shipToCode: "1240088" },
    { siteCode: "ASP NES", siteName: "NORTH EAST SQUARE", invoicePrefix: "NESSRR#", address: "2/L Northeast Square, #47 Connecticut, St. Northeast Greenhills San Juan City, Metro Manila", contactEmails: '[]', shipToCode: "1102538" },
    { siteCode: "ASP GL5", siteName: "GLORIETTA 5", invoicePrefix: "GL5SSR#", address: "Unit 329 3/F Glorietta St., 5 Ayala Center, Brgy. San Lorenzo Makati City, Metro Manila", contactEmails: '[]', shipToCode: "1102537" },
    { siteCode: "ASP SMS", siteName: "S MAISON", invoicePrefix: "SMSSSR#", address: "2/L, Smaison At Conrad Manila, Seaside Blvd., Coral Way, Moa Complex, Brgy. 76 Pasay City, 1300", contactEmails: '[]', shipToCode: "1103790" },
    { siteCode: "APP MOA", siteName: "MALL OF ASIA", invoicePrefix: "MOASSR#", address: "2/L North Parking Building Cyberzone Power Mac Center Sm Mall Of Asia Barangay 76 Pasay City", contactEmails: '[]', shipToCode: "1597912" },
    { siteCode: "APP PPM", siteName: "POWER PLANT MALL", invoicePrefix: "PPMSSR#", address: "Power Mac Center R2 level Power Plant Mall, Brgy. Poblacion, Makati City, Metro Manila", contactEmails: '[]', shipToCode: "1603617" },
    { siteCode: "APP GB3", siteName: "GREENBELT 3", invoicePrefix: "GB3SSR#", address: "Space Nos. 214-215, 2/F, Greenbelt 3, Greenbelt Complex, Ayala Center Brgy. Lorenzo, Makati City 1228 MAKATI CITY - GREENBELT", contactEmails: '[]', shipToCode: "1645879" },
    { siteCode: "ASP NPM", siteName: "NEW POINT", invoicePrefix: "NPMSSR#", address: "Unit 1, 2F, Newpoint Mall, Doña Teresa Ave., Nepo Center, Angeles City Pampanga, Philippines, 2009", contactEmails: '[]', shipToCode: "1196666" },
    { siteCode: "ASP CEB", siteName: "ROBINSONS GALLERIA, CEBU", invoicePrefix: "CEBSSR#", address: "MOBILECARE SERVICES PHILS. INC. 0001102534 4033, 4/L ROBINSONS GALLERIA CEBU CEBU CITY 25 6000 PH", contactEmails: '[]', shipToCode: "1102534" },
    { siteCode: "ASP ABREEZA", siteName: "ABREEZA MALL, DAVAO", invoicePrefix: "ABRSSR#", address: "2nd floor, Abreeza Mall JP Laurel Avenue, Bajada Davao City Davao del Sur 8000", contactEmails: '[]', shipToCode: "1102535" },
    { siteCode: "ASP CDO", siteName: "LIMKETKAI MALL, CDO", invoicePrefix: "CDOSRR#", address: "2/L,EAST CONCOURSE LIMKETKAI MALL, CAGAYAN DE ORO CITY 48 9000, PH", contactEmails: '[]', shipToCode: "1218985" },
    { siteCode: "ASP ILOILO", siteName: "FESTIVE WALK MALL, ILOILO", invoicePrefix: "ILOSSR#", address: "G/F Festive Walk Mall, Iloilo Business Park, Airport Road, Mandurriao Iloilo City", contactEmails: '[]', shipToCode: null },
    { siteCode: "ASP NAG", siteName: "ROBINSONS NAGA", invoicePrefix: "NGSSR#", address: "Unit 101-101a, Level 1 Robinsons Naga, Brgy. Roxas Avenue, Cor Almeda Hwy, Naga City, Camarines Sur", contactEmails: '[]', shipToCode: "1730389" },
    { siteCode: "APP MEG", siteName: "SM MEGAMALL", invoicePrefix: "MGSSR#", address: "Bldg. B, Cyberzone, SM Megamall, Mandaluyong City 1550 Philippines", contactEmails: '[]', shipToCode: "1745440" },
    { siteCode: "APP ANX", siteName: "SM ANNEX", invoicePrefix: "ANSSR#", address: "SMCITY NORTH EDSA, BRGY. STO CRISTO, QUEZON CITY 46 1105, PH", contactEmails: '[]', shipToCode: "1764718" },
    { siteCode: "APP RM", siteName: "ROBINSONS MAGNOLIA", invoicePrefix: "RMSSR#", address: "Unit 211, Level 2, Robinsons Magnolia (Expansion Bldg), Aurora Blvd. Doña Hemady, Kaunlaran,Quezon City, Metro Manila, 1111", contactEmails: '[]', shipToCode: "1764735" },
    { siteCode: "APP TRI", siteName: "TRINOMA", invoicePrefix: "TRSSR#", address: "3rd Level, Mindanao Ave., TriNoma Mall, EDSA, cor North Ave, Quezon City, Metro Manila", contactEmails: '[]', shipToCode: "1764730" },
    { siteCode: "ASP LIM", siteName: "THE OUTLETS, LIMA Estate", invoicePrefix: "LMSSR#", address: "Blk A Unit R07-08, The Outlets at Lima Estates Lipa City, Batangas", contactEmails: '[]', shipToCode: "1754212" },
    { siteCode: "ASP LAU", siteName: "ROBINSONS LA UNION", invoicePrefix: "LUSSR#", address: "Space 316, Level 3, Digiworld, Robinsons Place La Union, National Highway, Sevilla, San Fernando, La Union", contactEmails: '[]', shipToCode: "1815649" },
    { siteCode: "ASP COTABATO", siteName: "KCC MALL, COTABATO", invoicePrefix: "CBOSSR#", address: "Space No. IL-226 2nd Floor, KCC Mall of Cotabato, 10 Quezon Ave., Rosary Heights 2, Cotabato City, Cotabato", contactEmails: '[]', shipToCode: null },
    { siteCode: "ASP FES", siteName: "FESTIVAL MALL, ALABANG", invoicePrefix: "FESSSR#", address: "Mobilecare Services Phils. Inc.-Fes 0001815657 Space No.Ugf-2274.2.1-Ugf-2274.2.2, Muntinlupa City 46 1781 Ph", contactEmails: '[]', shipToCode: "1815657" },
    { siteCode: "APP BHS", siteName: "BONIFACIO HIGH STREET", invoicePrefix: "BHSSSR#", address: "1F, Wumaco Building, 7th Ave cor. Lane P, High Street, Taguig, 1635", contactEmails: '[]', shipToCode: "1836095" },
    { siteCode: "ASP ZAM", siteName: "KCC MALL DE ZAMBOANGA", invoicePrefix: "ZAMSSR#", address: "Mobilecare services inc. 2/f east wing, KCC mall de zamboanga, Governor Camins Avenue, Camino Nuevo, 7000.", contactEmails: '[]', shipToCode: "1128342" },
