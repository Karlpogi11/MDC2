-- Revert: batch_upsert_parts should overwrite part_name on re-import (intentional correction)
-- The corruption source was import-stockin falling back part_name to part_number string, not this function.
